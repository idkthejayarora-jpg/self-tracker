      ...
      <div className="page-header flex items-center justify-between gap-3 mb-5">
        <div className="flex items-center gap-3">
          <div className="shrink-0 flex items-center justify-center rounded-2xl"
            style={{ width: 44, height: 44, background: '#f59e0b15', border: '1px solid #f59e0b25' }}>
            <Wallet size={22} style={{ color: '#f59e0b' }} strokeWidth={1.7} />
          </div>
          <div>
            <h1 className="text-2xl font-black text-head tracking-tight">Finance</h1>
            <p className="text-xs text-muted mt-0.5">Wealth tracking</p>
          </div>
        </div>
      </div>
