      ...
      <div className="page-header flex items-center justify-between gap-3 mb-5">
        <div className="flex items-center gap-3 flex-1 min-w-0">
          <div className="shrink-0 flex items-center justify-center rounded-2xl"
            ...
            <Bell size={22} style={{ color: '#f97316' }} strokeWidth={1.7} />
          </div>
          <div>
            <h1 className="text-2xl font-black text-head tracking-tight">Reminders</h1>
            <p className="text-xs text-muted mt-0.5">Scheduled alerts</p>
          </div>
        </div>
